  ...
  return (
    <div className="min-h-screen bg-[#0d0d0d] flex items-center justify-center p-4">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        <div className="absolute top-1/4 right-1/4 w-96 h-96 bg-purple/10 rounded-full blur-[150px]" />
        <div className="absolute bottom-1/4 left-1/4 w-80 h-80 bg-purple-light/10 rounded-full blur-[120px]" />
      </div>
